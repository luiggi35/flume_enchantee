...
mixin _$GameState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(GameEntity game) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(GameEntity game)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required this.game});
...
abstract class _Loaded implements GameState {
  const factory _Loaded({required final GameEntity game}) = _$LoadedImpl;
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'GameState.error(failure: $failure)';
  }
